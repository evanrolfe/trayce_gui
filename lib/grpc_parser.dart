...
/// Bindings to `grpc_parser/grpc_parser.h`.
class NativeLibrary {
  ...
  ffi.Pointer<ffi.Char> ParseProtoMessage(
    ffi.Pointer<ffi.Char> protoFile,
    ffi.Pointer<ffi.Char> methodPath,
    ffi.Pointer<ffi.Uint8> messageHex,
    int messageHexLen,
    int isResponse,
  ) {
    return _ParseProtoMessage(
      protoFile,
      methodPath,
      messageHex,
      messageHexLen,
  ...
  late final _ParseProtoMessagePtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(
              ...
              ffi.Int,
              ffi.Int)>>('ParseProtoMessage');
  late final _ParseProtoMessage = _ParseProtoMessagePtr.asFunction<
      ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>,
          ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Uint8>, int, int)>();
  ...
  late final _AddOnePtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Int)>>('AddOne');
  late final _AddOne = _AddOnePtr.asFunction<int Function(int)>();
