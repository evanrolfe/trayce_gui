...
class CodeFindPanelView extends StatelessWidget implements PreferredSizeWidget {
  ...
  const CodeFindPanelView({
    ...
    this.decoration = textFieldDecor,
  });
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: SizedBox(
          ...
          child: Container(
            decoration: BoxDecoration(color: statusBarBackground),
            child: Column(
              children: [
  ...
  Widget _buildFindInputView(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        Text(result, style: textFieldStyle),
        Expanded(
          child: Row(
            mainAxisAlignment: MainAxisAlignment.end,
            children: [
  ...
  Widget _buildCheckText({
    ...
    TextStyle textStyle;
    if (checked) {
      textStyle = TextStyle(color: selectedColor, fontSize: inputFontSize, fontWeight: FontWeight.bold);
    } else {
      textStyle = TextStyle(color: lightTextColor, fontSize: inputFontSize, fontWeight: FontWeight.normal);
    }
    ...
    return GestureDetector(
      ...
      child: MouseRegion(
        ...
        child: SizedBox(width: _kDefaultFindIconWidth * 0.75, child: Text(text, style: textStyle)),
      ),
    );
  }
  ...
  Widget _buildIconButton({required IconData icon, VoidCallback? onPressed, String? tooltip}) {
    return IconButton(
      onPressed: onPressed,
      icon: Icon(icon, size: iconSize, color: lightTextColor),
