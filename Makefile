...
generate:
	...
	pyside6-uic src/network/ui/ui_proto_defs_dialog.ui -o src/network/ui/ui_proto_defs_dialog.py
...
# Mac:
	sed -i '' 's|import api_pb2 as api__pb2|from . import api_pb2 as api__pb2|' src/agent/api_pb2_grpc.py
# Linux:
# sed -i 's/import api_pb2 as api__pb2/from . import api_pb2 as api__pb2/' src/agent/api_pb2_grpc.py
