...
void main() {
  ...
  group('Editor HTTP Path Params', () {
    testWidgets('new request with params and save', (WidgetTester tester) async {
      ...
      paramsController.rows()[0].valueController.text = '123';
      paramsController.rows()[1].valueController.text = 'name,age';
      ...
      expect(contents, contains('https://example.com/users/:id/show/:fields'));
      expect(
        contents,
