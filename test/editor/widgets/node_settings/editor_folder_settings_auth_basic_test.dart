...
void main() {
  ...
  group('Editor Folder Settings', () {
    testWidgets('saving basic auth on a folder', (WidgetTester tester) async {
      ...
      await tester.pumpAndSettle();
      await tester.tap(find.text('Basic Auth').last);
      await tester.pumpAndSettle();
  ...
  password: 1234abcd
    ...
    testWidgets('loading basic auth on a folder', (WidgetTester tester) async {
      ...
      expect(authController.getUsernameController().text, 'admin');
      expect(authController.getPasswordController().text, '1234abcd');
    });
  });
}
